...
import { SALES_HISTORY_ROUTE } from '@/utils/routes/routes.consts'
import { useReturnForm } from './hooks/use-retrurn-form'
        ...
        },
        {
            ...
            render: (_, record, index: number) => (
                <Input
                    ...
                    onChange={(e) => updateTotal(index, 'quantity', Number(e.target.value))}
                />
            ),
        },
        {
        ...
        },
        {
            ...
            render: (_, record, index: number) => (
                <Input
                    ...
                    step={0.1}
                    value={record.price ?? ''}
                    onChange={(e) => updateTotal(index, 'price', Number(e.target.value))}
                />
            ),
        },
        {
                ...
                >
                    ...
                    <div className={classes.buttons}>
                        {id && (
                            <Button
                                danger
                                onClick={() => navigate(SALES_HISTORY_ROUTE)}
                                style={{ flex: 1 }}
                            >
                                {t('Отмена')}
                            </Button>
